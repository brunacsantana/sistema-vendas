...
public class ClientesDAO {
    ...
    public void cadastrarCliente(Clientes obj) {
        try {
            ...
            //Passo 1 - criar o comando sql
            String sql = "insert into tb_clientes (nome,rg,cpf,email,telefone,celular,cep,endereco,numero,complemento,bairro,cidade,estado) "
                    + " values (?,?,?,?,?,?,?,?,?,?,?,?,?)";

            //Passo 2 - conectar o banco de dados e organizar o comando sql
    ...
    public List<Clientes> listarClientes() {
        try {
            ...
            //Passo 2 - criar o sql, organizar e executar
    ...
    public Clientes consultaPorNome(String nome) {
        try {
            //Passo 1 - criar o sql, organizar e executar
    ...
    //Metodo buscar cliente por nome em lista
